...
public class MobilityServices {
  ...
  private JsonObject makeTrainApiCall(String userClass, Location sourceLoc, Location destLoc,
     ...
     */
    RentalCarTrip sourceCarTrip = new RentalCarTrip("100.5 Meters", "5.6 Minutes", "20.50 EUR", "Taxi");
    TrainTrip trainTrip = new TrainTrip("100.5 Kms", "45.7 Minutes", "20.50 EUR", "FirstClass", 1);
    carClass = findCarClass(destTrainStation, destLoc, userClass);
    RentalCarTrip destCarTrip = new RentalCarTrip("100.5 Meters", "5.6 Minutes", "20.50 EUR", "Taxi");
  ...
  private JsonObject makeCarApiCall(String userClass, Location sourceLoc, Location destLoc,
     ...
     * Hint - See solution of exercise 1 to find the parameters of each API call
     */
    rentalCarTrip = new RentalCarTrip("100.5 Meters", "5.6 Minutes", "20.50 EUR", "Taxi");
